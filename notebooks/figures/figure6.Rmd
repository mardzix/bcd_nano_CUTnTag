...
pdf('/data/proj/GCB_MB/bcd_CT/single-cell/results/figures/figure_6/scRNA_Expression_heatmap_scVelo_genes.pdf', width=10,height=10)
pheatmap(scVelo.matrix[,names(sort(scRNA$pt))],
         cluster_cols = FALSE,
         treeheight_row = 0,show_colnames = FALSE,annotation_col = ann_col, show_rownames = TRUE,
